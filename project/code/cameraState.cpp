...
const D3DXVECTOR3 POSR_DEFAULT_RESULT = { 800.0f,50.0f,-400.0f };	// マルチモードのリザルト中のデフォルト注視点位置
const D3DXVECTOR3 POSV_DEFAULT_RESULT = { 800.0f,400.0f,-2400.0f };	// マルチモードのリザルト中のデフォルト視点位置

const D3DXVECTOR3 POSV_DISTANCE = { 0.0f, 1500.0f, -1500.0f }; // カメラの距離
